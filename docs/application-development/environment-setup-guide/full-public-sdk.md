...
1. Back up and remove the local SDK. Select OpenHarmony, then navigate to the directory where the original SDK is installed.
...
```
3. Under `xxx\\Sdk\\`, create a directory named after the API version, such as `18`. Extract the compressed files into this directory to produce the structure shown below.
    <img src='../deveco-studio/images/image21.png'>  

4. Verify the SDK in the IDE. After the IDE loads the Full API, rebuild the project.
